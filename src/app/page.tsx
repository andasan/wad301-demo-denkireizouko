...
export default function Home() {
	return (
		<section className="w-full relative mx-auto my-auto px-4 sm:max-w-xl md:max-w-full md:px-8 lg:py-32 xl:px-20">
				...
				<div className="mb-16 text-center lg:mb-0 lg:max-w-lg lg:text-left">
					<div className="mb-6 max-w-xl">
						...
						<h2 className="mb-6 max-w-lg font-sans text-3xl font-bold tracking-tight text-slate-700 sm:text-5xl sm:leading-snug">
							...
							<br />
							in your&nbsp;
							<span className="inline-block text-green-500">Kitchen</span>
						</h2>
						<p className="text-base text-gray-700 md:text-lg">
							ReizApp is a web-based application that allows you to manage your
